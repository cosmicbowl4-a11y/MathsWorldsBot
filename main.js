...
camera.position.z = 50; // zoomed out for larger circle
...
// Geometry: larger, smoother circle
const geometry = createWavyCircle(20, 1024, 0.05, 15);
...
function animate() {
  ...
  circle.rotation.z += 0.002; // slower rotation for big shape
