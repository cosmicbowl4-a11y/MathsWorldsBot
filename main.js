...
// Wavy button with UVs (centered)
function createWavyCircleWithUV(radius, segments, waveAmplitude, waveFrequency) {
...
const buttonGeometry = createWavyCircleWithUV(1, 128, 0.1, 6);
...
// Morphing logic (geometry swap for reliability)
function nextStage() {
  stage++;
  material.uniforms.mixValue.value = stage / 4.0; // animate gradient shift
